...
# Fixtures
@pytest.fixture(scope="function",params=((dataset, get_testchunk_dates(dataset)) for dataset in data_sets[0:2]))
def remote_dataset(request,record_xml_attribute,record_property):
    ...
    for k in dkeys: record_xml_attribute(k, dataset.meta_info[k])
